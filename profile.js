...
async function deletePost(secretID, locationID){
    ...
    const result = await axios({
        method: 'delete',
        url: `https://enigmatic-meadow-24377.herokuapp.com/secret/${secretID}`,
        withCredentials: true
    });
    console.log(result);
}catch(err){
...
try{
    let location = await axios({
        method: 'get',
        url: `https://rocky-chamber-40639.herokuapp.com/location/${locationID}`,
    });
...
//'https://enigmatic-meadow-24377.herokuapp.com'